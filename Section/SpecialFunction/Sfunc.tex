...
\subsubsection*{Another form of Gaussian integral.} Here we state without proof.
\begin{align*}
    \int_{-\infty}^{\infty}\exp \left( -\alpha x^2+\beta x\right)\;dx&= \sqrt{\frac{\pi}{\alpha}} \exp \left(\frac{\beta^2}{4\alpha}\right)\\
...
\subsubsection*{Integrals.} Here are some integral in term of gamma function and Riemann zeta function.
\begin{align*}
