...
\begin{longtable}{@{} CCC @{}}
    ...
    \mathcal{L}25 & \begin{matrix}f(t)=u(t-a)-u(t-b)\\ \includegraphics[width=0.3\textwidth]{../../../Rss/AnalyticsApproach/ODE/L25} \end{matrix}
   &  \begin{matrix}\dfrac{e^{-ap}-e^-bp}{p}  \\ \\\text{All }p\end{matrix}\\ \\
    \mathcal{L}26 &\begin{matrix}\includegraphics[width=0.3\textwidth]{../../../Rss/AnalyticsApproach/ODE/L26}\end{matrix}& \begin{matrix} \dfrac{1}{p}\tanh \frac{ap}{2} \\\\ \text{All }p \end{matrix}\\ \\
