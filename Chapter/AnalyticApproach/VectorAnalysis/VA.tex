...
\begin{align*}
    ...
    \end{vmatrix}
\end{align*}
Consider the cross product of two vector
\begin{equation*}
    \A \times \B = e_1
    \begin{pmatrix}
        A_2 & A_3 & \\
    ...
    \end{pmatrix}
\end{equation*}
The $i$-th component is written as
\begin{equation*}
    (\A \times \B)_i = \epsilon_{ijk} A_j B_k
\end{equation*}
For $i=1$, the surviving terms are from even $(123)$ and odd $(132)$ permutations
\begin{equation*}
    (\A \times \B)_1 = A_2B_3 - A_3B_2
\end{equation*}
For $i=2$, the surviving terms are from even $(231)$ and odd $(213)$ permutations
\begin{equation*}
    (\A \times \B)_2 = A_3B_1 - A_1B_3
\end{equation*}
For $i=1$, the surviving terms are from even $(312)$ and odd $(321)$ permutations
\begin{equation*}
