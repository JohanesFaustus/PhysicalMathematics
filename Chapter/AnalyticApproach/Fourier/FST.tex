...
\begin{longtable}{@{} CCC @{}}
    ...
    \\\\
    \mathcal{F}3  & e^{-at}u(x)                    & \begin{matrix} \frac{1}{a+ik}\\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}4  & e^{at}u(-x)                    & \begin{matrix} \frac{1}{a-ik}\\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}5  & e^{-|t|}                       & \begin{matrix} \frac{2a}{a^{2}+k^{2}} \\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}6  & t e^{-at}u(x)                  & \begin{matrix} \frac{1}{(a+ik)^{2}}\\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}7  & t^{n}e^{-at}u(x)               & \begin{matrix} \frac{n!}{(a+ik)^{n+1}} \\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}8  & e^{jk_{0}t}               & 2\pi \delta(k-k_0)
    \\\\
    \mathcal{F}9  & \cos(k_{0}x)              & \pi [\delta(k-k_0)+\delta(k+k_0)]
    \\\\
    \mathcal{F}10 & \sin(k_{0}x)              & \pi [\delta(k-k_0)-\delta(k+k_0)] / i                                                                                 \\\\
    ...
    \\\\
    \mathcal{F}14 & e^{-at}\sin(k_0 x)\,u(x)  & \begin{matrix} \frac{k_0}{(a+ik)^2+k_0^2} \\\\ a>0\end{matrix}
    \\\\
    \mathcal{F}15 & e^{-at}\cos(k_0 x)\,u(x)  & \begin{matrix}\frac{a+ik}{(a+ik)^2+k_0^2} \\\\ a>0\end{matrix}
    \\\\
    \bottomrule
\end{longtable}
\end{document}